...
import { importRoles, type ImportRolesData } from "@/services/rbac"

interface RolesImportSheetProps {
  open: boolean
...
export function RolesImportSheet({ open, onOpenChange, onImportSuccess }: RolesImportSheetProps) {
  ...
  const [result, setResult] = React.useState<ImportRolesData | null>(null)
