...
import { CreateAssetDialog } from "@/components/assets/dialogs/create-asset-dialog"
import { CreateFolderDialog } from "@/components/assets/dialogs/create-folder-dialog"
import { DeleteFolderDialog } from "@/components/assets/dialogs/delete-folder-dialog"
import { DeleteDocumentDialog } from "@/components/assets/dialogs/delete-document-dialog"
  ...
  const handleFileClick = useCallback(
    async (node: FileNode) => {
      if (node.type === "document") {
        // Navigate directly to the asset page with the document ID
        // The asset page will handle loading the document and its folder hierarchy
