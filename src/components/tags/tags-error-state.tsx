...
import type { TagsErrorStateProps } from '@/types/tags'

export type { TagsErrorStateProps } from '@/types/tags'

export function TagsErrorState({ error, onRetry }: TagsErrorStateProps) {
