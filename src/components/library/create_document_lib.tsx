...
export default function CreateDocumentLib({ 
  trigger, 
  folderId, 
  onDocumentCreated 
}: CreateDocumentLibProps) {
  ...
  const mutation = useMutation({
    ...
    onError: (error: Error) => {
      setError(error.message || "An error occurred while creating the asset");
    },
  });
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the fields below to create a new asset.
          </DialogDescription>
        </DialogHeader>
