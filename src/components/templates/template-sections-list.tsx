      ...
      <div className="relative isolate">
        ...
        >
          <SortableContext items={sections.map((s: any) => s.id)} strategy={verticalListSortingStrategy}>
            <div className={`space-y-1.5 sm:space-y-2 overflow-visible max-h-[75vh] overflow-y-auto ${isReordering ? 'opacity-0' : ''}`}>
              {sections.map((section: any) => (
                <div key={section.id} className="border border-gray-200 rounded-md bg-gray-50 overflow-visible">
