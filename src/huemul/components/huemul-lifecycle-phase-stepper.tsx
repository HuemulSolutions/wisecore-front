          ...
          <Fragment key={phase.key}>
            {index > 0 && (
              <div
                className={cn(
                  "mt-2.5 h-px flex-1",
                  segmentDone ? lifecycleStageTone(previous.key).solid : "bg-border",
                )}
              />
            )}
            <div className="flex shrink-0 flex-col items-center gap-1 px-1">
              <span
                className={cn(
                  ...
                  phase.state === "upcoming" ? "bg-muted-foreground/25" : tone.solid,
                )}
              >
              ...
              <span
                className={cn(
                  ...
                  phase.state === "upcoming" ? "text-muted-foreground" : tone.text,
                )}
              >
                {phase.label}
              </span>
