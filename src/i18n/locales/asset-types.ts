const translations = {
  ...
  lifecycle: {
    ...
    allowAnyoneDescOff: { en: "Only the asset owner can execute this phase.", es: "Solo el propietario del activo puede ejecutar esta fase." },
    ownerCanExecuteLabel: { en: "Owner can execute this phase", es: "El propietario puede ejecutar esta fase" },
    ownerCanExecuteDescOn: { en: "The document owner can execute this phase.", es: "El dueño del documento puede ejecutar esta fase." },
    ownerCanExecuteDescOff: { en: "Only roles with assigned permissions can execute this phase.", es: "Solo los roles con permisos asignados pueden ejecutar esta fase." },
