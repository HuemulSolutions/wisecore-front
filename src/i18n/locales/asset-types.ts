const translations = {
  ...
  exportImport: {
    ...
    exportDescription: { en: "Choose what content to include in the export.", es: "Elige qué contenido incluir en la exportación." },
    exportSummary: { en: "Exporting {{count}} asset type(s).", es: "Exportando {{count}} tipo(s) de activo." },
