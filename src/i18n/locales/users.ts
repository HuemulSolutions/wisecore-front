const translations = {
  ...
  detail: {
    ...
    authMethodSelfTitle: { en: "Change your own sign-in method?", es: "¿Cambiar tu propio método de inicio de sesión?" },
    authMethodSelfDescription: { en: "From now on you will have to sign in to this organization with {{provider}}. If that connection is not working, you will lose access until another admin changes it back.", es: "Desde ahora tendrás que entrar a esta organización con {{provider}}. Si esa conexión no funciona, perderás el acceso hasta que otro admin lo revierta." },
    authMethodSelfConfirm: { en: "Change method", es: "Cambiar método" },
    authMethodDescription: { en: "Applies only to this organization. Other organizations keep their own method.", es: "Aplica solo a esta organización. En otras organizaciones se mantiene su propio método." },
