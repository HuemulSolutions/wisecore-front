const translations = {
  ...
  exportImport: {
    ...
    exportSelectionRequired: { en: "Select at least one role to export.", es: "Selecciona al menos un rol para exportar." },
    exportError: { en: "Error exporting roles", es: "Error al exportar roles" },
    importTitle: { en: "Import Roles", es: "Importar Roles" },
    importDescription: { en: "Upload a JSON file exported from another environment to create or update roles.", es: "Sube un archivo JSON exportado desde otro ambiente para crear o actualizar roles." },
