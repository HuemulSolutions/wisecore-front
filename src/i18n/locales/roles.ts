const translations = {
  ...
  edit: {
    ...
    description: { en: "Update the permissions assigned to this role.", es: "Actualizar los permisos asignados a este rol." },
  },
  delete: {
  ...
  assignToUsers: {
    ...
    errorDescription: { en: "There was an error loading the users data. Please try again.", es: "Ocurrió un error al cargar los datos de usuarios. Reintentar." },
  ...
  assignRoles: {
    ...
    errorDescription: { en: "There was an error loading the roles data. Please try again.", es: "Ocurrió un error al cargar los datos de roles. Reintentar." },
  },
  picker: {
