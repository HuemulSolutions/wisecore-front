const translations = {
  ...
  filters: {
    ...
    pendingMyActionReview: { en: "Awaiting my review", es: "Esperan mi revisión" },
    pendingMyActionApprove: { en: "Awaiting my approval", es: "Esperan mi aprobación" },
    pendingMyActionAny: { en: "Awaiting my review or approval", es: "Esperan mi revisión o aprobación" },
