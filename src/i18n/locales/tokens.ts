const translations = {
  header: {
    ...
    description: {
      ...
      es: "Administrar los tokens de API usados para autenticar solicitudes a Wisecore.",
    },
  ...
  list: {
    ...
    emptyDescription: {
      ...
      es: "Crear un token para autenticar solicitudes externas a la API.",
    },
  ...
  create: {
    ...
    description: {
      ...
      es: "Asignar un nombre al token y definir su periodo de validez.",
    },
  ...
  reveal: {
    ...
    warning: {
      ...
      es: "Copiar este token ahora. Por seguridad, no se volverá a mostrar.",
    },
