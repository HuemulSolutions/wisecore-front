const translations = {
  ...
  settings: {
    groups: {
      assetStructure: { en: "Asset Structure", es: "Estructura de Activos" },
      designFiles: { en: "Design & Files", es: "Diseño y Archivos" },
      peopleAccess: { en: "People & Access", es: "Personas y Permisos" },
      connectionsAi: { en: "Connections & AI", es: "Conexiones e IA" },
      toolsUsage: { en: "Tools & Usage", es: "Herramientas y Consumo" },
