const translations = {
  ...
  knowledge: {
    ...
    documentDeletedSuccess: {
      en: "Document \"{{name}}\" deleted successfully",
      es: "Documento \"{{name}}\" eliminado correctamente",
    },
    documentDeleteError: {
      en: "Failed to delete document. Please try again.",
      es: "Error al eliminar el documento. Inténtalo de nuevo.",
    },
    folderMovedSuccess: { en: "Folder moved successfully", es: "Carpeta movida correctamente" },
    folderMoveError: {
      en: "Failed to move folder. Please try again.",
      es: "Error al mover la carpeta. Inténtalo de nuevo.",
    },
    documentMovedSuccess: { en: "Document moved successfully", es: "Documento movido correctamente" },
    documentMoveError: {
